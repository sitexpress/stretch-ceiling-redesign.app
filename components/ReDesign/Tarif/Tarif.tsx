        ...
        <Group bg="gray.1">
            <Container size="xl" className={classes.wrapper}>
                ...
                <Flex
                    ...
                    p="lg"
                    bg="white"
                    style={{ border: "1px solid #e9ecef", borderRadius: 20 }}
                    align="start"
                >
                    <Text size="xl" className={classes.text}>
                        &emsp;&emsp;С 2014 года мы создаем стильные и уютные интерьеры, преображая обычные помещения в пространства
                        ...
                        застройщика, выявим все недочеты и учтем усадку дома, чтобы ваш ремонт оставался безупречным
                        годами.
                    </Text>
                    <Text size="xl" mt="lg" className={classes.text}>
